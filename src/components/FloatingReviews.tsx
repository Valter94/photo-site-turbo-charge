...
const FloatingReviews = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 hidden lg:block">
      <Card 
        className={`w-64 bg-white/95 backdrop-blur-sm border-pink-200 shadow-xl transform transition-all duration-500 hover:scale-105 ${
      ...
      >
        <CardContent className="p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-xs font-semibold text-gray-700">Свежий отзыв</span>
